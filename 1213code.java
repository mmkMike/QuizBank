...
//                                new InputStreamReader(getAssets().open("quiz1/" + images[i])));
                        ...
                        while ((line = bufferedReader.readLine()) != null) {
                            ...
                            if (lineVals[0].equalsIgnoreCase("score")) {
                                resultList.add(Integer.parseInt(lineVals[1].trim()));
                                resultCount += 1;

                            }
                            if (lineVals[0].equalsIgnoreCase("questionNumbers")) {
                                questionList.add(Integer.parseInt(lineVals[1].trim()));

                            }
                            //pretty much dupe these codes to make the common mistake detector and get larger data
...
//                    }
                ...
                double questionNumbers = questionList.get(1);
                averageCalc = (double) sum / resultCount;
                averageTotal = (double) (averageCalc/questionNumbers)*100;


//                tv_text.setText(resultList.toString());

//                tv_text.setText(Arrays.toString(fileCount));
                tv_text.setText(String.valueOf(averageTotal + "%"));
//                tv_text.setText(String.valueOf(resultCount));
